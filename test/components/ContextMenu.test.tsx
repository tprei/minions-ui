...
const mockRunningSession: ApiSession = {
  id: 'session-1',
  slug: 'bold-meadow',
  status: 'running',
...
const mockCompletedSession: ApiSession = {
  id: 'session-2',
  slug: 'calm-lake',
  status: 'completed',
...
const mockSessionWithQuickActions: ApiSession = {
  ...mockRunningSession,
  id: 'session-3',
  slug: 'swift-river',
  quickActions: [
...
const mockPendingSession: ApiSession = {
  ...mockRunningSession,
  id: 'session-4',
  slug: 'quiet-hill',
  status: 'pending',
...
describe('ContextMenu', () => {
  ...
  it('renders Send Reply and stop/close actions for a running session', () => {
    render(
      <ContextMenu
  ...
  it('does not render "Open in Telegram" item', () => {
    render(
      <ContextMenu
        session={mockRunningSession}
        position={{ x: 100, y: 100 }}
  ...
  it('shows stop confirm dialog on Stop Minion click', () => {
    render(
      <ContextMenu
        session={mockRunningSession}
        position={{ x: 100, y: 100 }}
  ...
  it('shows close confirm dialog on Close Session click', () => {
    render(
      <ContextMenu
        session={mockRunningSession}
        position={{ x: 100, y: 100 }}
