import type { AttentionReason, ApiDagNode, ApiSession } from '../api/types'
import { useTheme } from '../hooks/useTheme'

export type StatusType = ApiSession['status'] | ApiDagNode['status']
...
export function StatusBadge({ status }: StatusBadgeProps) {
  ...
  const className = theme.value === 'dark' ? config.darkClassName : config.className
...
export function getAttentionBorder(session: ApiSession, darkMode: boolean): string {
