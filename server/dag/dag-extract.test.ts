import { describe, it, expect, vi, afterEach, beforeEach, mock } from "bun:test"
import { ParseError } from "./claude-extract"
import { parseDagItems, parseStackItems, buildDagChildPrompt, extractDagItems, extractStackItems } from "./dag-extract"
import type { TopicMessage, ProviderProfile } from "./types"
import type { DagInput } from "./dag"
import type { SpawnedChild } from "./claude-extract"
...
describe("extractDagItems profile environment", () => {
  ...
  function createMockChildProcess(output: string = "[]"): SpawnedChild {
    return {
